...
from lesson3.store.Cart import Cart
from lesson3.store.Catalog import Catalog
from lesson3.store.Category import Category
from lesson3.store.Item import Item
...
cart = Cart()
# Передаем объект cart в метод класса Каталог лишь для того, чтобы из класса Cart запустить
# метод добавления товара в корзину, который есть в классе Корзина
